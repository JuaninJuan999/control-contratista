...
<div class="relative shrink-0" id="menu-usuario">
    <button
        ...
        aria-haspopup="true"
        class="inline-flex items-center gap-1 rounded-lg border border-emerald-700 bg-emerald-700 px-2 py-1.5 text-xs font-bold uppercase tracking-wide text-white shadow-sm transition hover:bg-emerald-800 sm:gap-1.5 sm:px-3 sm:text-sm"
    >
