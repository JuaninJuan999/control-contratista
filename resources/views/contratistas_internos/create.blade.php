...
@section('title', 'Nuevo contratista interno — '.config('app.name'))
...
@section('content')
    ...
    <div class="max-w-4xl rounded-lg border border-zinc-200 bg-white p-4 shadow-lg md:p-5">
        ...
        <form action="{{ route('contratistas-internos.store') }}" method="post" enctype="multipart/form-data" class="flex flex-col gap-3">
            @csrf
